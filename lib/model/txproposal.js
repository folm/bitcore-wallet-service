...
TxProposal.fromObj = function(obj) {
  ...
  console.log('x.actions', x.actions);
...
TxProposal.prototype._buildTx = function() {
  ...
  console.log("setting time of tx to "+self.createdOn);
  t.settime(self.time);
...
TxProposal.prototype.sign = function(copayerId, signatures, xpub) {
  try {
    ...
    console.log('copayerId, signatures, xpub', copayerId, signatures, xpub);
    console.log('sign getBitcoreTx');
    var tx = this.getBitcoreTx();
    console.log('sign _addSignaturesToBitcoreTx');
    this._addSignaturesToBitcoreTx(tx, signatures, xpub);
    console.log('sign addAction');
    ...
    console.log('sign raw', this.raw);
    console.log('sign txid', this.txid);

    return true;
  } catch (e) {
    log.debug(e);
    console.log('sign catch', e);
    return false;
  }
};
